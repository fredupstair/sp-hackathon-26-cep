define([], function() {
  return {
    ...
    "CopilotBubbleLabel": "Copilot ha qualcosa per te",
    "CopilotBubbleLoading": "Sta scrivendo un messaggio solo per te\u2026",
    "CopilotLoadingHint": "Sto generando una risposta personalizzata per te\u2026",
    "CopilotLoadingHint2": "Un attimo di pazienza\u2026",
    ...
    "AiWelcomeStaticIntro": "Ciao **{0}**! Sono contento che tu sia qui. Copilot per Microsoft 365 \u00e8 il tuo AI companion \u2014 funziona direttamente in **Teams**, **Outlook**, **Word**, **Excel** e in tutte le app che gi\u00e0 usi ogni giorno.{1} Ecco cosa pu\u00f2 fare concretamente per te:",
    "AiWelcomeStaticRoleHint": " Pu\u00f2 sicuramente aiutarti per tematiche relative a **{0}**.",
    "AiWelcomeClosing": "Che dici, vuoi iniziare?",
    ...
    "TabUniverse": "Universo",
    "TabStats": "Statistiche",
    "UniversePromptsLabel": "prompt",
    "UniverseOfTotal": "del totale",
    "UniversePoints": "punti",
    "UniverseLockedWorlds": "🔒 Mondi bloccati",
    "UniverseLockedHint": "Usa Copilot in {0} e sblocca questo mondo!",
    ...
    // Copilot Win card
    "WinCardTitle": "Copilot Win",
    "WinStatPoints": "{0} pts guadagnati"
  };
});
